...
(function(window) {
    ...
    const DEFAULT_OPTIONS = {
        ...
        aspectRatio: 1.3,
        palette: [
            // Палитра 0: Venn Classic (правильное смешивание цветов)
            {
                background: '#f8f8f8',
                empty: '#e0e0e0',
                set1: '#FFB3BA',      // Розовый (левый нижний круг)
                set2: '#87CEEB',      // Голубой (правый нижний круг)
                set3: '#6BC96C',      // Зелёный (верхний круг)
                intersection12: '#C8B3E0',  // Розовый + Голубой = Сиреневый
                intersection13: '#F4E5A0',  // Розовый + Зелёный = Жёлтый
                intersection23: '#7DD8C0',  // Голубой + Зелёный = Бирюзовый
                intersection123: '#F5F5F5', // Все три = Белый/светло-серый
                set1a: '#FF9BA3',     // Тёмный розовый
                set1b: '#FFCCD0',     // Светлый розовый
                set2a: '#6BB8E0',     // Тёмный голубой
                set2b: '#A3DDF5',     // Светлый голубой
                set3a: '#4FB350',     // Тёмный зелёный
                set3b: '#8FDB8F',     // Светлый зелёный
                border: 'rgba(0,0,0,0.15)'
            },
            // Палитра 1: Пастельная (старая)
            {
                background: '#2a2a2a',
                empty: '#000000',
                set1: '#f5c7c7',
